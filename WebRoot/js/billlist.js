...
function deleteBill(obj){
	$.ajax({
		type:"GET",
		url:path+"/bill/deletebill.do/" + obj.attr("billid"),
		dataType:"json",
...
$(function(){
	$(".viewBill").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/bill/findbill.do/"+ obj.attr("billid");
	});
	
	$(".modifyBill").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/bill/findbill2.do/"+ obj.attr("billid");
	});
	$('#no').click(function () {
		cancleBtn();
	});
