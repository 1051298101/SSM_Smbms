                ...
                <tr class="firstTr">
                   ...
                   <c:forEach var="role" items="${roleList }" varStatus="status">
					<tr>
						...
						<td>
							<span><a class="modifyRole" href="javascript:;" roleid=${role.id } roleName=${role.roleName }><img src="${pageContext.request.contextPath }/images/xiugai.png" alt="修改" title="修改"/></a></span>
							<span>
								<a class="deleteRole" href="javascript:;" roleid=${role.id } roleName=${role.roleName }>
